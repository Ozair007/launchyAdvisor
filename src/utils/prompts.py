ORCHESTRATOR_AGENT_PROMPT = """
            ...
            Given the following insights from relevant experts, analyze the information deeply and generate a structured, actionable JSON string:
...
MARKETING_AGENT_PROMPT = """
            ...
            Return ONLY a JSON string with the following fields:\n
...
CRITIC_EXPERT_AGENT_PROMPT = """
            ...
            Return ONLY an actionable JSON string with these fields:
